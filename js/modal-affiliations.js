        ...
        <div id="affiliationModal" onclick="closeAffiliationModal()" 
            ...
            <div onclick="event.stopImmediatePropagation()" 
                ...
                <div class="px-8 pt-8 pb-6 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
                    <div>
                        <h3 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">${affiliationName}</h3>
                        <p class="text-slate-500 dark:text-slate-400 mt-1">Politikere med samme tilknytning</p>
                    </div>
